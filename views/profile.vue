    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        ...
        <main class="mdl-layout__content" style="justify-content: center; align-items: center;">
            ...
            <div class="mdl-card mdl-shadow--6dp"
                 style="margin: auto; overflow: initial; max-width: 500px;width: 100%;">
            ...
            <a href="./" class="mdl-button mdl-js-button mdl-button--fab mdl-button--colored"
               style="height: 56px; position: fixed; right: 0; bottom: 0; margin-bottom: 2em; margin-right: 2em;"><i
